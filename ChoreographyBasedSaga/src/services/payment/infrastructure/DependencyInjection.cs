...
namespace infrastructure
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, Action<DependencyOptions> options)
        {
            ...
            {
                x.ConnectionString = dependencyOptions.Value.Configuration.GetConnectionString("PaymentDb");
            ...
            //services.AddDbContext<PaymentDbContext>(options => options.UseInMemoryDatabase(databaseName: "PaymentSubDomain")); 
